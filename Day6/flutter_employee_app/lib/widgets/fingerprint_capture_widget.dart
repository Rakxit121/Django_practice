...
class FingerprintCaptureWidget extends StatelessWidget {
  final bool isScanned;
  final Function(File) onCapture; // Callback function to handle image capture
  final String
      captureType; // Added capture type to differentiate between left, right, or signature

  const FingerprintCaptureWidget({
    super.key,
    required this.isScanned,
    required this.onCapture,
    required this.captureType, // Capture type
  });
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isScanned ? Colors.greenAccent : Colors.white,
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Icon(
                isScanned ? Icons.check : Icons.fingerprint,
                color: isScanned ? Colors.white : Colors.grey,
                size: 40,
              ),
